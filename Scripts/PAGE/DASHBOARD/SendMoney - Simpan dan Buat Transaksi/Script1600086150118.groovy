...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/SEND_MONEY/btnSimpanBuatTransaksiLagi'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForJQueryLoad(20)

WebUI.waitForElementPresent(findTestObject('Object Repository/SEND_MONEY/linkLihat'), 10)

WebUI.waitForElementClickable(findTestObject('Object Repository/SEND_MONEY/linkLihat'), 10)

CustomKeywords.'com.fl.flipwebsite.general.screenCapture'(p_intNo, "FlipIdWebsite")

WebUI.click(findTestObject('Object Repository/SEND_MONEY/linkLihat'), FailureHandling.STOP_ON_FAILURE)
